...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-lg-3">
                <div class="card p-4">
                    <a href={{ route('stupro') }}><section>Student progress</section></a>
                    <hr>
                    <a href={{ route('mypro') }}><section>My progress</section></a>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="card p-4">
                    ...
                    <hr>
                    <span>You dont have any teachers yet</span>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="card p-4">
                    ...
                    <hr>
                    <span class="fst-italic text-body-secondary">Teachers</span>
